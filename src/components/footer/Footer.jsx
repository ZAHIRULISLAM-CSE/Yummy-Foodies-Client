      ...
      <footer className="w-[85%] mt-12 mx-auto">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-5">
            ...
            <div>
              <h2 className="mb-6 font-semibold text-xl  text-black uppercase dark:text-white">
                Help center
              </h2>
            ...
            <div>
              <h2 className="mb-6 text-xl  text-black font-semibold  uppercase dark:text-white">
                Legal
              </h2>
              <ul className="text-gray-300 dark:text-gray-400 font-medium">
                <li className="mb-4">
            ...
            <div>
              <h2 className="mb-6 text-xl  text-black font-semibold  uppercase ">
                Download
              </h2>
              <ul className="text-gray-300 dark:text-gray-400 font-medium">
                <li className="mb-4">
